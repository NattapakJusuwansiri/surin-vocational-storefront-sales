    ...
    <div class="invoice">
        ...
        <table class="no-border" style="margin-top:10px;">
            <tr>
                <td>
                    ชื่อผู้รับสินค้า
                    <span class="dotted-line" style="width: 80%; text-align: left; padding-left:10px;">{{ $document->buyer_name ?? ''}}</span>
                </td>
            </tr>
            <tr>
                <td>
                    สถานที่จัดส่ง
                    <span class="dotted-line" style="width: 80%; text-align: left; padding-left:10px;">{{ $document->buyer_address ?? ''}}</span>
                </td>
            </tr>
            <tr>
                <td>
