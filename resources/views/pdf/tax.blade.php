    ...
    <div class="invoice">
        ...
        <table class="no-border" style="margin-top:10px;">
            <tr>
                ...
                <td class="text-right">
                    เล่มที่ <span class="dotted-line" style="width: 80px; text-align: center;"></span>
                    เลขที่ <span class="dotted-line"
        ...
        <table class="no-border">
            <tr>
                <td>
                    ชื่อผู้ขาย
                    <span class="dotted-line" style="width: 90%; text-align: center;">
                    </span>
                </td>
            </tr>
            <tr>
                <td>
                    ที่อยู่
                    <span class="dotted-line" style="width: 93%; text-align: center;">
                    </span>
                </td>
            </tr>
            <tr>
        ...
        <table class="no-border" style="margin-top:10px;">
            <tr>
                <td>
                    ชื่อผู้ซื้อ
                    <span class="dotted-line" style="width: 91%; text-align: center;">
                    </span>
                </td>
            </tr>
            <tr>
