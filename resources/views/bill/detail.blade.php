...
@section('desktop-content')
    ...
    <div class="container p-5 bg-white rounded-5">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <a href="{{ route('receipts.index') }}" class="btn btn-secondary btn-sm">กลับไปหน้ารวมบิล</a>
            </div>
            <div class="col-md-6 d-flex justify-content-end">
                <div class="col-md-6 d-flex justify-content-end">
                    <a href="{{ route('receipts.detail.export', $items->first()->bill_id) }}"
                        class="btn btn-success btn-sm me-2">Export Excel</a>
                    {{-- {{ route('receipts.detail.pdf', $items->first()->bill_id) }} --}}
            ...
            <table class="table table-bordered table-striped text-center align-middle">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><strong>{{ number_format($paid ?? $totalPrice, 2) }}</strong></td>
                    </tr>
                    <tr>
                        <td colspan="3" class="text-end"><strong>ทอน:</strong></td>
                        <td colspan="2"><strong>{{ number_format($change ?? 0, 2) }}</strong></td>
                    </tr>
                </tfoot>
            </table>
        </div>
