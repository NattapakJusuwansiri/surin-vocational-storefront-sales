...
@section('desktop-content')
    ...
    <div class="container p-5 bg-white rounded-5">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <a href="{{ route('receipts.index', request()->only(['start_date', 'end_date', 'search'])) }}"
            ...
            <div class="col-md-6 d-flex justify-content-end">
                <div class="col-md-6 d-flex justify-content-end">
                    {{-- ส่งช่วงวันที่ Excel ด้วย --}}
                    <a href="{{ route('receipts.detail.export', ['bill_id' => $items->first()->bill_id] + request()->only(['start_date', 'end_date'])) }}"
